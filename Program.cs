    ...
    class Program
    {
        ...
        */
        ...
        public static int RemoveDuplicates(int[] nums)
        {
            try
            {
                // Count for keeping track of the unique elements
                int k = 1; 
                ...
                for (int i = 1; i < nums.Length; i++)
                {
                    ...
                    if (nums[i] != nums[i - 1])
                    {
                        nums[k] = nums[i]; // Moving the unique element to the next available position
                        k++; // Increment the Count for unique elements
                    }
                }
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                // Initializing nonzeroposition to keep track of the position for non-zero elements
        ...
        */
        ...
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            try
            {
                Array.Sort(nums); // Sorting the array to maintain ascending order
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                // Initializing variables to store maximum count and current count of consecutive ones
                int maxcount = 0;
                int count = 0;
                ...
                for (int i = 0; i < nums.Length; i++)
                {
                    ...
                    {
                        // If current element is 0, update maxCount and reset count
                        maxcount = Math.Max(maxcount, count);
                        count = 0;
                    }
                }

                // Updating maxCount with the final count
                maxcount = Math.Max(maxcount, count);
        ...
        */
        ...
        public static int BinaryToDecimal(int binarynumber)
        {
            try
            {
                // Initializing variables to hold decimal result and position factor
                int decimalValue = 0;
                int factor = 1;
                ...
                {
                    // Extracting the last digit of binary number
                    int digit = binarynumber % 10;

                    // Adding the contribution of current binary digit to decimal value
                    decimalValue += digit * factor;

                    // Move to the next binary digit and adjust the position factor
                    binarynumber /= 10;
                    factor *= 2;
                }
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                // Checking the array if it contains less than two elements and return 0
                if (nums.Length < 2)
                    return 0;
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                // Sorting the array in descending order to find the largest sides first
                Array.Sort(nums);
                Array.Reverse(nums);
                ...
                for (int i = 0; i <= nums.Length - 2; i++)
                {
                    ...
                    // Checking the sides if it's possible to form a triangle
                    if (x < y + z)
                    {
                        // Return the value of the perimeter of the triangle
                        return x + y + z;
                    }
                }
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            try
            {
                // Searching and removing all occurrences of 'part' from 's'
                while (s.Contains(part))
                {
                    int index = s.IndexOf(part); // Finding the leftmost occurrence of 'part'
                    s = s.Remove(index, part.Length); // Removing 'part' from 's'
                }
